...
gxrgxn["funcpaypal"] = nil -- Aqui coloque a função que retorna o valor do paypal do "user_id".
...
gxrgxn["armamentos"] = true -- Para habilitar/desabilitar informações das armas
